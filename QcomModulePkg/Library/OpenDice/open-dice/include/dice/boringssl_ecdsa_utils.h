...
int
P256KeypairFromSeed (uint8_t public_key[P256_PUBLIC_KEY_SIZE],
...
int
P256Sign (uint8_t signature[P256_SIGNATURE_SIZE],
...
// from |message|.
int
P256Verify (const uint8_t *message,
            size_t message_size,
...
// implementation defined format so may only be passed to the |sign| operation.
int
P384KeypairFromSeed (uint8_t public_key[P384_PUBLIC_KEY_SIZE],
...
// the buffer where the calculated signature is written.
int
P384Sign (uint8_t signature[P384_SIGNATURE_SIZE],
          const uint8_t *message,
          size_t message_size,
...
// from |message|.
int
P384Verify (const uint8_t *message,
            size_t message_size,
