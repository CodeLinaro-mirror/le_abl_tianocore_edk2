...
typedef enum {
  ...
  SOFT_SKU_SWCFG_SPARE0_STATUS_ALL,
  SOFT_SKU_SWCFG_SPARE1_STATUS_ALL,
  SOFT_SKU_SWCFG_SPARE2_STATUS_ALL,
  SOFT_SKU_SWCFG_SPARE3_STATUS_ALL,
  SOFT_SKU_SWCFG_SPARE4_STATUS_ALL,
  SOFT_SKU_SWCFG_SPARE5_STATUS_ALL,
  SOFT_SKU_SWCFG_ITRACKER,
  SOFT_SKU_SWCFG_SOC_OPERATION_MODE,
  SOFT_SKU_SWCFG_VERSION,
