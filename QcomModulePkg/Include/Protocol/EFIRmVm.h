...
/**
  Defines for VM_GET_HYP_RESOURCES
*/
/* Resource Types (from caller's point of view)*/
#define VM_DOORBELL_SOURCE_OBJ  0
#define VM_DOORBELL_OBJ         1
#define VM_MSG_QUEUE_SEND_OBJ   2
#define VM_MSG_QUEUE_RECV_OBJ   3
#define VM_VIRT_CPU_OBJ         4
#define VM_VIRT_PM_GROUP_OBJ    5
#define VM_VIRT_IO_MMIO_OBJ     6


typedef struct __attribute__((packed)) _RmHypResourceEntry
{
  UINT8   ResourceType;      /**< Type of Hyp VM Resource from caller’s point of view*/
  UINT8   Reserved;
  UINT16  PartnerVmid;          /**< VMID of the partner VM associated with this object, usually same as the VMID requested.*/
  UINT32  ResHandle;
  UINT32  ResLabel;
  UINT32  ResCapIdLow;
  UINT32  ResCapIdHigh;
  UINT32  ResVirqHandle;
  UINT32  ResVirqNumber;
  UINT32  ResBaseAddrLow;
  UINT32  ResBaseAddrHigh;
  UINT32  ResSizeLow;
  UINT32  ResSizeHigh;
} RmHypResourceEntry;

typedef struct __attribute__((packed)) _RmVmGetHypResResponse
{
  UINT16 ResourceEntriesCount;        /**< Total number of entries*/
  UINT16 Reserved;
  RmHypResourceEntry ResEntries[];    /**< Start of entries */
} RmVmGetHypResResponse;
...
/* ============================================================================
**  Function : EFI_RM_VM_GET_HYP_RESOURCES
** ============================================================================
*/
/** @ingroup efi_rm_vm_get_hyp_resources
  @par Summary
  Call into Resource Manager to query information about a VM’s local resources
  for hypervisor objects connected to other VMs
...
typedef
EFI_STATUS
(EFIAPI *EFI_RM_VM_GET_HYP_RESOURCES)(
   IN   RmVmProtocol   *This,
   IN   UINT16              VmID,
   OUT  VOID                **DataBuff,
   OUT  UINT32              *DataBuffSize
...
typedef struct _EFI_RMVMINTF_PROTOCOL {
  ...
  EFI_RM_VM_GET_HYP_RESOURCES VmGetHypResources;
} RmVmProtocol;
#endif /* __EFIRMVM_H__ */
