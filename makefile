...
ABL_FV_IMG: EDK_TOOLS_BIN
	...
	-D HIBERNATION_SUPPORT_INSECURE=$(HIBERNATION_SUPPORT_INSECURE) \
	-D HIBERNATION_SUPPORT_SECURE=$(HIBERNATION_SUPPORT_SECURE) \
	-D HIBERNATION_32BIT_MODE_SWITCH=$(HIBERNATION_32BIT_MODE_SWITCH) \
	...
	-D UBUNTU_AB_OTA=$(UBUNTU_AB_OTA) \
        -D RESTORE_FDE_KEY=$(RESTORE_FDE_KEY) \
